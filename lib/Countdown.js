...
var Countdown = function (_Component) {
  ...
  _createClass(Countdown, [{
    ...
    value: function tick() {
      ...
      var format = this.props.options.format || '%days %daysDescription %hours %hoursDescrption %minutes %minutesDescription %seconds %secondsDescription';
      var remaining = (0, _DateBetween2.default)(startDate, endDate, format);
